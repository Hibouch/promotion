...
require '../entities/Addons/PHPMailer/src/Exception.php';
require '../entities/Addons/PHPMailer/src/PHPMailer.php';
require '../entities/Addons/PHPMailer/src/SMTP.php';
...
if (!empty($_POST['Mail_Body']) && !empty($_POST['Mail_Title']))
{
  ...
  foreach ($Array as $row)
  {
    ...
    $mail->Username   = 'hibouba.sboui@gmail.com';                     // SMTP username
    $mail->Password   = 'hibasboui11';                               // SMTP password
